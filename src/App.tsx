...
export function App() {
    ...
    <>
      ...
      <div className="text-slate-600 bg-slate-300 flex justify-center">
        <div className="md:w-4/5 lg:w-3/5 w-11/12">
          ...
          <div className="rounded-t-3xl bg-slate-50 p-8 shadow-xl drop-shadow-2xl">
            ...
            <p className="mb-8">
              ...
              working full-time for the government. I do silly things in my spare
              time such as playing Valorant, Honkai: Star Rail, Minecraft, scrolling social media,
              etc. Oh and I do arts too, I want to become a game developer
              someday, however my journey is still far ahead.
            </p>
            ...
            <div className="flex md:flex-row flex-col gap-4">
              <Project>
                <img src="digisign.png" alt="" className="border rounded-md" />
  ...
  function Project({ children }: { children: React.ReactNode }) {
    return (
      <div className="p-4 rounded-md border shadow-md md:basis-1/2 hover:bg-slate-100 ease-in-out transition-all">
        {children}
      </div>
    );
  }
